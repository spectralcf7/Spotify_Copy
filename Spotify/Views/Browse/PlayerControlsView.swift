...
//  Spotify
//
//  Created by Mihnea Amihailesei on 20.05.2024.
//
...
final class PlayerControlsView: UIView {
    ...
    override func layoutSubviews() {
        ...
        backButton.frame = CGRect(x: playPauseButton.left - 65 - buttonSize, y: playPauseButton.top, width: buttonSize, height: buttonSize)
        nextButton.frame = CGRect(x: playPauseButton.right + 65, y: playPauseButton.top, width: buttonSize, height: buttonSize)
    }
